...
main_container.style.padding="15px"
...
products.forEach(function(v,i,a){
    ...
    card_container.style.backgroundColor="gray"
    ...
    pro_image.setAttribute("width","150px")


    card_container.append(pro_image)
    card_container.append(pro_id)
    card_container.append(pro_title)
    card_container.append(pro_price)
    card_container.append(pro_rating)

    main_container.append(card_container)
    //pro_rating.remove() //- --> removes the self element
    // card_container.removeChild(pro_rating) // we need specify the parent.removechild(child)
